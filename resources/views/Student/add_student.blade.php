          ...
          <div class="wrapper mt-3">
           <div class="row ">
               <div class="div col-md-12">
                   <h2 class="d-flex justify-content-center"><b>Student Information Add</b></h2>
                    <form action="{{route('student_store')}}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" class="form-control" id="first_name" placeholder="email..." name="email">
                                </div>
                               </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="dob" placeholder="birth date" name="dob">
                                </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="present_address" placeholder="present_address..." name="present_address">
                                </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="parmanent_address" placeholder="parmanent_address..." name="parmanent_address">
                                </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="father_profession" placeholder="father_profession..." name="father_profession">
                                </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="mother_name" placeholder="mother_name..." name="mother_name">
                                </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="mother_profession" placeholder="mother_profession..." name="mother_profession">
                                </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="emergency_contact_number" placeholder="emergency_contact_number..." name="emergency_contact_number">
                                </div>
                                </div>
                            </div>
                        </div>
